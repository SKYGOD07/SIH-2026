      ...
      <PageHeader
        ...
        aside={
          <dl className="flex flex-wrap gap-x-10 gap-y-4">
            <div>
              <dt className="font-mono text-meta uppercase text-silver">On register</dt>
              <dd className="mt-2 font-display text-3xl leading-none text-ivory">
                {STARTUPS.length}
              </dd>
            </div>
            <div>
              <dt className="font-mono text-meta uppercase text-silver">Compliance verified</dt>
              <dd className="mt-2 font-display text-3xl leading-none text-validated-light">
                {verified}
              </dd>
            </div>
          </dl>
