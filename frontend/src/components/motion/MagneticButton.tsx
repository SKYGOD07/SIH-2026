...
const VARIANT = {
  solid: 'bg-signal text-chalk hover:bg-signal-light border-signal',
  outline: 'border-chalk/25 text-chalk hover:border-signal hover:text-signal',
  ghost: 'border-transparent text-chalk/50 hover:text-chalk',
} as const;
